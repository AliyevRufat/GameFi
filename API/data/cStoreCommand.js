class cStoreCommand{
    constructor(){
        // add new player and set the initial points to 10
        ...
        // update the transaction hash in to vault_transaction

...
class SmartContractDAO
{
    ...
    async getBalance(address) {
        try {
          ...
          var contract = await new this.web3.eth.Contract(flopabi, this.token_address);
    ...
    async withdraw(address, amount){
        ...
        var rs = await vault_contract.methods.withdraw(value, address).send({ from: this.withdrawer_address, gas: 3000000 });
